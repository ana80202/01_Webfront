...
document.querySelector("#btn1").addEventListener("click",() => {
   ...
   //->  li1 부모 노드 배경색 변경하기
   li1.parentNode.style.backgroundColor = "lightcoral";
