...
function check1() {
    ...
    if(value > 0) { // vlaue가 0보다 커서 true인 경우
        alert("양수입니다");
    }


    // vlaue가 0과 같거나 작아서 true인 경우
    // -> value가 양수가 아닌 경우
    if(value <= 0) { 
        alert("양수가 아닙니다");
    }
...
function check3() {
    ...
    let message = randomNumber + "은/는" + "0입니다";
...
const inputAge = document.getElementById("inputAge"); //input 태그 자체를 얻어옴
